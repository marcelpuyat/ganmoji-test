...
def Generator(z, reuse=False, name='g'):
	...
	with tf.variable_scope(name, reuse=reuse):
		...
		extra_layer_conv = Conv2d(G_h2, output_dim=1024, kernel=(3,3), strides=(1,1), name='conv_extra')
		extra_layer_bn = BatchNormalization(extra_layer_conv, name="conv_extra_bn")
		extra_layer_relu = LeakyReLU(extra_layer_bn)
		...
		extra_layer_conv_2 = Conv2d(G_h3, output_dim=512, kernel=(3,3), strides=(1,1), name='conv_extra_2')
		extra_layer_bn_2 = BatchNormalization(extra_layer_conv_2, name="conv_extra_bn_2")
		extra_layer_relu_2 = LeakyReLU(extra_layer_bn_2)
		...
		extra_layer_conv_3 = Conv2d(G_h4, output_dim=256, kernel=(3,3), strides=(1,1), name='conv_extra_3')
		extra_layer_bn_3 = BatchNormalization(extra_layer_conv_3, name="conv_extra_bn_3")
		extra_layer_relu_3 = LeakyReLU(extra_layer_bn_3)

		G_conv5 = Deconv2d(extra_layer_relu_3, output_dim=4, batch_size=config.BATCH_SIZE, name='deconv5')
